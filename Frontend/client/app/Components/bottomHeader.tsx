...
export function BottomContainer() {
  return (
    <>
      <div className="w-full bg-black p-5 mt-[6rem] md:mt-[10rem] border-t-2 border-b-2 border-t-slate-300 border-b-slate-300 flex flex-col items-center justify-center">
